...
| Producer — Stockclips-Modus (19.06.2026) | ✅ Implementiert | Neuer visueller Stil `Stockclips-Cluster` im Producer: kontemplative Videos können statt KI-Bildern echte Pexels-Videoclips (8 Sek., 1920x1080) aus genau einem thematischen Cluster verwenden — mehr Bewegung in den ersten Minuten für bessere Retention, spart fal.ai-Kosten. Aktivierung über CSV-Felder `Visueller_Stil` + `Landschaft_Suchbegriffe`. Pexels API Key bereits in context/secrets.md vorhanden. Isoliert getestet (3 Clips, normalisiert, zu Testvideo zusammengesetzt, Exit 0) — noch kein echtes Produktionsvideo damit gelaufen. Details: plans/2026-06-19-stockclips-hook-retention.md |
