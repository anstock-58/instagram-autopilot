...
| Zuverlässigkeit Schedule | Gelöst ✅ (08.06.2026) | Ursache gefunden: cron-job.org-Job „Instagram Stories 09:00 — Andi Mentalgesund" war inaktiv (vermutlich nach ein paar Fehlschlägen automatisch deaktiviert) — während die Jobs der anderen 3 Accounts brav liefen, lief dieser seit Tagen gar nicht mehr, GitHub-interne Backup-Crons fingen es nicht zuverlässig auf. Fix: Job reaktiviert, Auto-Deaktivierung bei Fehlschlägen ausgeschaltet, Testlauf bestätigt 204 No Content. Ab 09.06. sollte die Story wieder von selbst laufen — kein manueller Trigger mehr nötig |
| Wording-Regeln Instagram | Umgesetzt ✅ (06.06.2026) | Verbindliche Regeln in reference/content-regeln-instagram.md — Gedankenstriche aus allen kommenden CTAs entfernt (business/mit-system/mentalgesund, je 60 Posts: „— schreib X" → „, schreib X") — ki_support am 06.06.2026 ebenfalls bereinigt (CSV neu gebaut, Gedankenstriche raus) |
| @business.und.spirit Autopilot | Live ✅ | Blotato ID 46248 — contentplan_business_und_spirit_juni_v2.csv (60 Posts, 01.06.–30.06.2026) — Stimme: Charlie — Emojis: max 2-3 pro Post (dezent/professionell) — Captions 08.06.2026 überarbeitet: alle 49 geplanten Posts haben jetzt eine Brücke zwischen Problem und Standortcheck-CTA (Hook → Brücke → CTA statt CTA als Fremdkörper), zusätzlich 3 Kurs-Promo-Stories korrigiert die fälschlich den Standortcheck statt den Kurs bewarben |
| @ki_support Autopilot | Live ✅ | Blotato ID 46341 — contentplan_ki_support_juni_v2.csv am 06.06.2026 neu gebaut (50 saubere Zeilen 06.–30.06., voll-zitiert, Phantomzeilen entfernt, 23.06 Reel repariert, Gedankenstriche raus) — Backup-Schedule-Zeiten aktiv — Stimme: Daniel (British) — Emojis: 4-6 pro Post |
| @andi.mit.system Autopilot | Live ✅ | Blotato ID 46471 — contentplan_andi_mit_system_juni_v2.csv — Stimme: Daniel (British) — Emojis: 4-6 pro Post — ACHTUNG: Reels liefen seit 20.05. nicht (Export-Csv \r-Bug, behoben 25.05.2026) |
| @andi.mentalgesund Autopilot | Live ✅ | Blotato ID aus Secret MENTALGESUND_ACCOUNT_ID — contentplan_andi_mentalgesund_juni_v2.csv — Stimme: Charlie (Australian) — Emojis: 4-6 pro Post |
