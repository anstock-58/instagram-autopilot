...
| Producer — Stockclips-Modus (19.06.2026) | ✅ Live im Einsatz | Neuer visueller Stil `Stockclips-Cluster` im Producer: kontemplative Videos können statt KI-Bildern echte Pexels-Videoclips (8 Sek., 1920x1080) aus genau einem thematischen Cluster verwenden — mehr Bewegung in den ersten Minuten für bessere Retention, spart fal.ai-Kosten. Aktivierung über CSV-Felder `Visueller_Stil` + `Landschaft_Suchbegriffe`. Erstes echtes Produktionsvideo erfolgreich: „Was Menschen sehen, wenn sie sterben" (BewusstEinfach, 21.06., unlisted, https://www.youtube.com/watch?v=z8buees2ZGE) — noch prüfen und auf öffentlich/Zeitplan setzen. Details: plans/2026-06-19-stockclips-hook-retention.md |
