...
- **Noch offen/nicht bestätigt:** ob Anton/das Programm auf Andis eigene Frage aus der Vorbereitung eingegangen ist, ob die Teilnahme erst nach dem ersten B+H-Honorar starten/bezahlt werden kann, oder ob eine Vorabzahlung/erste Rate vor dem B+H-Zahlungseingang fällig wird — angesichts von Andis finanzieller Lage (siehe `project_finanzielle_situation` in der Memory) ein wichtiger, noch zu klärender Punkt vor einer Zusage.
- **Praktische Sorge, noch nicht mit Andi besprochen:** 12+ Live-Calls/Woche plus tägliche Erreichbarkeit ist eine hohe Zeitbindung, die mit dem eigentlichen B+H-Bau-Aufbau konkurrieren könnte — passt zu Andis eigener, selbst erkannter Gefahr der Zersplitterung über zu viele parallele Projekte.
