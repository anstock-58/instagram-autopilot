...
Die Datei `./context/cc-anweisung.md` enthält verbindliche Verhaltensanweisungen. Diese gelten ab sofort für die gesamte Session — nicht als Option, sondern als Standard.
