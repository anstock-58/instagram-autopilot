...
### Schritt 6: Session-Log speichern

Erstelle automatisch eine Datei in `outputs/session-logs/` mit dem Dateinamen `YYYY-MM-DD-session.md` (heutiges Datum).
...
## Nicht vergessen
[was offen blieb oder wichtig ist]

## Geänderte Dateien
[Liste der Dateien, die in dieser Session bearbeitet wurden]
```
